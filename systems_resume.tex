...
%   Coursework
\courseWork{Information Security}{Systems and Networks}{Natural Language Processing}{Deep Learning}{Machine Learning}{Database Systems}{Computer Organization and Programming}{Algorithm Analysis}{Data Structures and Algorithms}{; Objects and Design}{; Math of Data Science}{; Statistical Theory}{; Stochastic Processes}{; Robotics}{; A.I.}{; Probability Theory}
...
%--------------------------------------------------------------
\begin{skillList}
    \singleItem{Programming Languages:}{\textit{Proficient:} Python, Java, C, SQL  \textit{ Familiar:} Rust, C++, TypeScript, Assembly (x86), Bash, R.}\\
    \singleItem{Libraries, Frameworks, Etc.:}{PyTorch, Scikit-learn, NumPy, Pandas, STL, Matplotlib, SciPy, LangChain, Seaborn, Git, AWS CDK.}\\
    ...
    \singleItem{Misc.:}{Containerization (Docker), Databases, Data Structures, Algorithms, OOP/OOD, VCS, Agile Methodology, CI/CD.}
\end{skillList}
