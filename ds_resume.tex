...
%   Coursework
\courseWork{Natural Language Processing}{Deep Learning}{Machine Learning}{Math of Data Science}{Statistical Theory}{Information Security}{Database Systems}{Stochastic Processes}{Robotics}{; Information Theory}{; A.I.}{; Probability Theory}{; Algorithm Analysis}{; Data Structures and Algorithms}{; Real Analysis}{; Complex Analysis}{; Systems and Networks}{; Computer Organization and Programming}
...
%--------------------------------------------------------------
\begin{skillList}
    \singleItem{Programming Languages:}{\textit{Highly Proficient:} Python, Java. \textit{ Proficient:} SQL, Typescript, C. \textit{ Familiar:} Rust, Bash, MATLAB, R, C++.}\\
    \singleItem{Libraries, Frameworks, Etc.:}{PyTorch, Scikit-learn, NumPy, Pandas, Matplotlib, SciPy, Keras, LangChain, Seaborn, Git, AWS CDK.}\\
    \singleItem{Cloud Computing:}{Amazon DynamoDB, AWS Lambda, Amazon S3, AWS Glue, Amazon Redshift, AWS Step Functions.}\\
    ...
    \singleItem{Misc.:}{Containerization (Docker), Computer Systems, Databases, Data Structures, Algorithms, OOP/OOD, VCS, Agile, CI/CD.}
\end{skillList}
...
\begin{bullets}
    \item Led, mentored, and collaborated with a team of 12 Marines to prioritize mission accomplishment under hazardous working conditions and stressful environments as part of Weapons Plt., Fox Co., 2/6 in support of riflemen for numerous training operations and two overseas deployments for a total of 15 months deployed.
\end{bullets}
...
\begin{bullets}
    \item Parameter estimation and modeling at the NSF and NSA sponsored research program hosted by NC State University. Used PINNs and equation learning to infer an ODE for an agent-based model with adaptive behavior.
\end{bullets}
...
Surveyed simple random walks from both a probabilistic and enumerative approach.
\smallskip
